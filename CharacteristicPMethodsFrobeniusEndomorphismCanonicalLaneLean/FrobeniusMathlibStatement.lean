import CharacteristicPMethodsFrobeniusEndomorphismCanonicalLaneLean.FrobeniusFinalTheorem
...
def theoremSpecificEndgamePilotClosed : Prop :=
  forall A : FrobeniusAdmissibleClass, ConstrainedFrobeniusClosure A

theorem theorem_specific_endgame_pilot_checked :
    theoremSpecificEndgamePilotClosed := by
  intro A
  exact constrained_frobenius_endgame A
